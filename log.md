...
- 갱신 범위: [[mapped/Integration/Creator]] 1개 페이지만 안정 디벨롭 단계에 맞춰 압축했다.
...
- 정리: 표시 제목을 한국어 기본값에 맞춰 `창작자들`로 바꾸고, `한눈에 보는 요약`, `핵심 논지`, 반복 패턴, 정리 메모를 `핵심 판단 모델`, 원문 장면별 구조, 후속 흡수 기준으로 접었다. 제품 디자인·감상법·장범준 제작 메모는 독립 확장 이력이 아니라 원문 장면 안의 판단 축으로 재배치했다.
