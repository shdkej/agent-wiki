...
## 2026-05-28 05:17 UTC | Human/Evolve 네 칸 압축

- 갱신 범위: [[mapped/Human/Evolve]] 1개 페이지만 수정했다.
- 탐구: 대응 원본 `source/shdkej-content/Human/Evolve.md` 전체와 기존 mapped 노트 전체를 다시 읽고, 최근 평가의 `작은 수정 / 큰 전환 / 복잡성 그릇 / 사람·세대 속도` 압축 요구를 반영했다. 외부 링크 소스는 사용하지 않았다.
- 정리: 중복되던 메타 해석층과 실행 이력성 말미를 걷어내고, 원문 장면을 네 칸 변화 운영판과 기준 수명 관리로 재배치했다. 태그/카테고리, 모노레포/멀티레포, 이력서·민원·책 분류, 사람 변화와 세대 변화의 원문 질감을 더 앞에 남겼다.
- 드리프트 점검: 대응 원본은 file mtime 기준으로 mapped 노트보다 오래되어 이번 런의 직접 사용자 수정본으로 보이지 않았고, `human-reviews/` 복사는 생략했다.
...
## 2026-05-26 | Integration/Marketing 응답 표면 명칭 압축

- 갱신 범위: [[mapped/Integration/Marketing]] 1개 페이지만 수정했다.
- 탐구: 대응 원본 `source/shdkej-content/Integration/Marketing.md` 전체와 기존 mapped 노트 전체를 다시 읽고, 최근 평가의 외부 트렌드 명칭 축소 요구를 반영했다. 외부 링크 소스는 새로 확장하지 않았다.
- 정리: `AI/agent 제품 보조 자료`라는 자료명 중심 표현을 `새 보조 자료`와 대상·상황·차이·한계 점검으로 접어, Marketing 본문이 원문의 소비자 관점·UX 라이팅·전환 설계 경계 안에 머물게 했다.
- 드리프트 점검: 대응 원본은 mapped 노트보다 오래되어 이번 런의 직접 사용자 수정본으로 보이지 않았고, 따라서 `human-reviews/` 복사는 생략했다.
- 배포: `scripts/publish-agent-wiki.sh` 실행 대상으로 반영했다.
...
## 2026-05-23 11:17 UTC | Communication/Talk 반복층 점검

- 갱신 범위: [[mapped/Communication/Talk]] 1개 페이지만 수정했다.
- 탐구: 대응 원본 `source/shdkej-content/Communication/Talk.md` 전체와 기존 mapped 노트 전체를 다시 읽고, 최근 평가의 `반복해서 나타나는 패턴`과 `후속 정리 기준` 중복 가능성 지적을 반영했다. 외부 링크 소스는 참조하지 않았고, 관련 노트도 별도 편집하지 않았다.
- 정리: 5축 중심 모델은 유지하되 반복 패턴을 표로 압축하고, 후속 정리 기준은 같은 설명을 다시 말하지 않도록 새 메모를 어느 축에 붙일지 판단하는 흡수 표로 바꿨다.
- 선호 신호: 안정 단계의 Talk 노트는 새 해석을 더하기보다 원문 고유 장면과 5축 모델을 유지하고, 이후 메모가 어느 대화 상태에 붙는지 빠르게 판정하게 하는 편이 적합하다.
- 드리프트 점검: 대응 원본은 mapped보다 오래되었고 최근 git 변경 이력이 없어 이번 런의 직접 사용자 수정본으로 보이지 않았으며, `human-reviews/` 복사는 생략했다.

## 2026-05-28 16:20 UTC | Human/Standard 작업 이력층 압축

- 갱신 범위: [[mapped/Human/Standard]] 1개 페이지만 수정했다.
- 탐구: 대응 원본 `source/shdkej-content/Human/Standard.md` 전체와 기존 mapped 노트 전체를 다시 읽고, 최근 평가의 `이번 심화에서 보강한 점` 누적 지적을 반영했다. 외부 링크 소스는 참조하지 않았다.
- 정리: frontmatter와 H1을 한국어 기본값에 맞춰 `기준과 형식`으로 바꾸고, 본문 말미의 패스별 작업 이력 bullet을 제거했다. 대신 `강도 조절 / 예외 비용 / 생성 경로 / 인지 표면` 네 질문으로 후속 흡수 기준을 압축했다.
- 선호 신호: 안정 단계의 Standard 노트는 새 해석을 더하기보다 표준의 강도, 예외 처리, 생성 경로, 패턴 인식이라는 기존 판단 모델 안에 새 메모가 들어갈 수 있는지 먼저 판정하는 편이 적합하다.
- 드리프트 점검: 대응 원본은 mapped보다 오래되어 이번 런의 직접 사용자 수정본으로 보이지 않았으며, `human-reviews/` 복사는 생략했다.
